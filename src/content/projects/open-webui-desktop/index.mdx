...
cover:
  image: ./cover.png
  alt: Open WebUI on the desktop, ongoing chat session and sidebar open
  caption: "Open WebUI on the desktop, ongoing chat session and sidebar open"
showToc: true
weight: 1
---
import { Picture } from "astro:assets";
import chatgptPicture from "./chatgpt.png";
import openwebuiPicture from "./openwebui.png";
import chatbarAndCompanionPicture from "./chatbar-and-companion.jpg";
...
<Picture
  src={chatgptPicture}
  alt="ChatGPT's floating chatbar and companion chat"
  dpi={[1,1.5,2]}
  formats={['avif', 'webp']}
  densities={[1, 1.5, 2]}
  fallbackFormat="jpg"
...
<Picture
  src={openwebuiPicture}
  alt="Open WebUI chat page"
  dpi={[1,1.5,2]}
  formats={['avif', 'webp']}
  densities={[1, 1.5, 2]}
  fallbackFormat="jpg"
...
<Picture
  src={chatbarAndCompanionPicture}
  alt="Floating chatbar and companion chat"
  dpi={[1,1.5,2]}
  formats={['avif', 'webp']}
  densities={[1, 1.5, 2]}
  fallbackFormat="jpg"
